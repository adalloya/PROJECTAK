                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            <select
                                                name="country_code"
                                                defaultValue="+52"
                                                className="flex h-12 w-[110px] shrink-0 rounded-xl border border-input bg-background/50 px-3 py-2 text-sm shadow-sm transition-all focus:ring-2 focus:ring-primary/20 outline-none cursor-pointer text-foreground"
                                            >
